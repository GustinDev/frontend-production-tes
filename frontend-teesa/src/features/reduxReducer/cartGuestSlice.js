...
export const getCartGuestProducts = createAsyncThunk(
  'cartGuestProducts/getCartGuestProducts',
  async (userId) => {
    try {
...
export const updateCartGuestProducts = createAsyncThunk(
  'cartGuestProducts/updateCartGuestProducts',
...
export const deleteCartGuestProducts = createAsyncThunk(
  'cartGuestProducts/deleteCartGuestProducts',
