  ...
  return (
    <div className='flex flex-wrap justify-center'>
      <div
        className={`card flex flex-col items-center gap-4 m-4 p-6 w-80 h-auto min-w-80 max-w-md rounded-lg shadow-md transition-all duration-400 ${
          isHovered
            ...
            : 'border-2 border-teesaBlueLight bg-teesaWhite'
        }`}
      ...
      >
        ...
        <div
          className={`infoArea flex-grow text-center ${
            isHovered ? 'text-blue-900' : 'text-teesaBlueDark'
          }`}
        >
